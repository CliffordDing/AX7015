...
HD_PWD='f:/ax7015/demo/ibert_test/ibert_ex/ibert_ex.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log example_ibert.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source example_ibert.tcl -notrace
