...
HD_PWD='f:/ax7015/demo/ibert_test/ibert_ex/ibert_ex.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log example_ibert.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source example_ibert.tcl
