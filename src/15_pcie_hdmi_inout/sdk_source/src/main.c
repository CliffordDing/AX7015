...
#define IMAGE_BASE (512 * 1024 * 1024)
/* ------------------------------------------------------------ */
/*				Global Variables								*/
/* ------------------------------------------------------------ */
...
int main(void) {
	...
	i2c_reg8_write(&IicInstance, 0x60 >> 1, 0x05, 0x10);
	i2c_reg8_write(&IicInstance, 0x60 >> 1, 0x08, 0x05);
	i2c_reg8_write(&IicInstance, 0x60 >> 1, 0x09, 0x01);
	i2c_reg8_write(&IicInstance, 0x60 >> 1, 0x05, 0x04);
	i2c_reg8_write(&IicInstance, 0x60 >> 1, 0xb5, 0x04);
